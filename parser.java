...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Mar 20 12:09:18 CET 2018
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\064\000\002\002\004\000\002\010\003\000\002\014" +
    "\002\000\002\014\004\000\002\020\005\000\002\020\002" +
    ...
    "\006\000\002\004\005\000\002\004\006\000\002\004\012" +
    ...
    "\000\002\004\005\000\002\004\006\000\002\004\010\000" +
    "\002\004\006\000\002\004\003\000\002\012\003\000\002" +
    "\012\003\000\002\012\003\000\002\013\003\000\002\013" +
    "\003\000\002\005\006\000\002\005\010\000\002\006\005" +
    "\000\002\011\003\000\002\011\003\000\002\011\003\000" +
    "\002\011\003\000\002\011\003\000\002\007\011\000\002" +
    "\002\006" });
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\004\037\006\001\002\000\014\004\013\014\014" +
    "\022\007\026\011\032\010\001\002\000\004\002\uffd0\001" +
    "\002\000\004\002\uffd4\001\002\000\004\002\uffd1\001\002" +
    "\000\004\002\uffd5\001\002\000\004\002\uffd2\001\002\000" +
    "\004\002\uffd3\001\002\000\004\002\001\001\002" });
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 51: // block ::= LBRACE expArray expression RBRACE 
            {
              Blocks RESULT =null;
		...
		System.out.println("block"); ea.add(exp1); System.out.println(ea.toString()); RESULT = new Blocks(0,0,ea); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 50: // method ::= OBJECTIDENTIFIER LPAR formalArray RPAR COLON types block 
            {
              Method RESULT =null;
		...
		System.out.println("type1"); RESULT = new Types(0,0,t); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 44: // formals ::= OBJECTIDENTIFIER COLON types 
            {
              Formals RESULT =null;
		...
		System.out.println("formals1"); RESULT = new Formals(0,0,oi,t); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 43: // field ::= OBJECTIDENTIFIER COLON types ASSIGN expression SEMICOLON 
            {
              Field RESULT =null;
		...
		System.out.println("Field2"); RESULT = new Field(0,0,oi,t,e); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 42: // field ::= OBJECTIDENTIFIER COLON types SEMICOLON 
            {
              Field RESULT =null;
		...
		System.out.println("bool"); RESULT = b; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 38: // terminaison ::= STRINGLITERAL 
            {
              Terminal RESULT =null;
		...
		System.out.println("terminaison2"); RESULT = new Terminal(0, 0, sl); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 37: // terminaison ::= INTEGERLITERAL 
            {
              Terminal RESULT =null;
		...
		System.out.println("terminaison1"); RESULT = new Terminal(0, 0, it); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 36: // expression ::= terminaison 
            {
		...
		RESULT = ter; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 35: // expression ::= NEW LPAR types RPAR 
            {
              Expressions RESULT =null;
		...
		RESULT = new New(0, 0, ti);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 34: // expression ::= expression DOT OBJECTIDENTIFIER LPAR formalArray RPAR 
            {
              Expressions RESULT =null;
		...
		RESULT = new Call(0, 0, exp1, oi, fa); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 33: // expression ::= OBJECTIDENTIFIER LPAR formalArray RPAR 
            {
              Expressions RESULT =null;
		int oileft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int oiright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		...
		RESULT = new BinOp(0, 0, "//", exp1, exp2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 30: // expression ::= expression POW expression 
            {
              Expressions RESULT =null;
		int exp1left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int exp1right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		RESULT = new BinOp(0, 0, "+", exp1, exp2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 26: // expression ::= expression LOWEREQUAL expression 
            {
              Expressions RESULT =null;
		int exp1left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int exp1right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		RESULT = new BinOp(0, 0, "<=", exp1, exp2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 25: // expression ::= expression LOWER expression 
            {
              Expressions RESULT =null;
		int exp1left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int exp1right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		RESULT = new BinOp(0, 0, "=", exp1, exp2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 23: // expression ::= ISNULL expression 
            {
              Expressions RESULT =null;
		...
		RESULT = new UnOp(0, 0, "not", exp1); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 20: // expression ::= OBJECTIDENTIFIER ASSIGN expression 
            {
              Expressions RESULT =null;
		int oileft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int oiright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		RESULT = new Assign(0, 0, oi, exp1); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 19: // expression ::= LET OBJECTIDENTIFIER COLON types IN expression 
            {
              Expressions RESULT =null;
		...
		RESULT = new Let(0, 0, oi, ti, exp1); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 18: // expression ::= LET OBJECTIDENTIFIER COLON types ASSIGN expression IN expression 
            {
              Expressions RESULT =null;
		int oileft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)).left;
		int oiright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)).right;
		...
		System.out.println("expArray1"); ea.add(exp1); System.out.println(ea.toString()); RESULT = ea; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // classArray ::= classArray class 
            {
