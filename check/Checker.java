...
import java.util.Map;import parserClasses.*;
...
public class Checker {
    ...
    private HashMap<String, HashMap<String, ArrayList< Map.Entry<String, String> > > > classMethodFormalsType;
//    private HashMap<String, HashMap<String, HashMap<String, String> > > classMethodeFormalsType;
    ...
    public void displayStringHash() {
        ...
        System.out.println();
        for (HashMap.Entry<String, HashMap<String, ArrayList < Map.Entry<String, String> > > > classEntry : classMethodFormalsType.entrySet()) {
            System.out.print("nom classe : ");
            System.out.println(classEntry.getKey());

            for (HashMap.Entry<String, ArrayList < Map.Entry<String, String> > > methodEntry : classEntry.getValue().entrySet()) {
                System.out.print("\t nom methode : ");
                System.out.println(methodEntry.getKey());

                for (Map.Entry <String, String > formalEntry : methodEntry.getValue()) {
                    System.out.print("\t \t ");
    ...
    private void convertHashmap()
    {
        for(HashMap.Entry<String, Classe> classEntry: allowedClasses.entrySet()) {
            ...
            HashMap<String, ArrayList<Map.Entry<String, String> > > formalConvert = new HashMap<>();
            ...
            if(allowedMethods.containsKey(classEntry.getKey())){
                for (HashMap.Entry<String, Method> methodEntry : allowedMethods.get(classEntry.getKey()).entrySet()) {
                    ...
                    ArrayList< Map.Entry <String, String> > methodFormalConvert = new ArrayList<>();
                    if(methodEntry.getValue().getFormals().size() >0 ){
                        for (Formals formal : methodEntry.getValue().getFormals())
                            methodFormalConvert.add(new Map.Entry(formal.getIdentifier(), formal.getType()));
