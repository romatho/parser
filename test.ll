...
define %classe.Object* @Object-new() {
    %size = getelementptr  %classe.Object* null, i32 1
...
define void @Object-new-init(%classe.Object* %this) {
    %1 = getelementptr inbounds %classe.Object* %this, i32 0, i32 0
...
define %classe.Main* @Main-new() {
    %size = getelementptr  %classe.Main* null, i32 1
...
define void @Main-new-init(%classe.Main* %this) {
    ...
    %2 = getelementptr inbounds %classe.Main* %this, i32 0, i32 0
...
entry:
    ...
    %2 = getelementptr inbounds %classe.Main* %1, i32 0, i32 0
    %3 = load %table.MainVTable** %2
    %4 = getelementptr inbounds %table.MainVTable* %3, i32 0, i32 
    %5 = load %classe.IO* {}** %4
    %6 = call %classe.IO* %5 (%classe.Main* %1, null true)
    %7 = load %classe.Main** %0
    %8 = getelementptr inbounds %classe.Main* %7, i32 0, i32 0
    %9 = load %table.MainVTable** %8
    %10 = getelementptr inbounds %table.MainVTable* %9, i32 0, i32 
...
define %classe.IO* @IO-new() {
    %size = getelementptr  %classe.IO* null, i32 1
...
define void @IO-new-init(%classe.IO* %this) {
    %1 = getelementptr inbounds %classe.IO* %this, i32 0, i32 0
